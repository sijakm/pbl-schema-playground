...
export default function App() {
  ...
  const handleRunChain = async () => {
    ...
    log("Starting chain...");
    try {
      let p = window.prompts_collaborative;
      if (language === 'sr-Latn') p = window.prompts_collaborative_sr_Latn;
      else if (language === 'sr-Cyrl') p = window.prompts_collaborative_sr_Cyrl;
      else if (language === 'es') p = window.prompts_collaborative_es;
      else if (language === 'ru') p = window.prompts_collaborative_ru;
      else if (language === 'id') p = window.prompts_collaborative_id;
      if (!p) p = window.prompts_collaborative;
