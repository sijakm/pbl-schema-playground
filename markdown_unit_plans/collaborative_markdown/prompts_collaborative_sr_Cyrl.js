...
- Instruction:
  ...
  - Структура мора природно да тече са ознакама Реците/Урадите/Питајте/Ослушкујте/Напишите.
  - ВАЖНО: Не укључујте наслове великим словима (као УВОД, ПРЕДСТАВЉАЊЕ итд.) за одељке.
  - ВАЖНО: Не укључујте трајања у минутима за појединачне упуте или кораке.
  - TranscendentThinking: Наведите једно питање за примену у стварном свету које повезује учење са сврхом/смислом, затим ознаку 'Очекивани одговори ученика:' и 2–3 примера.
- GroupStructureAndRoles:
  - Излаз МОРА бити усмерен ка наставнику.
  - GroupSize: наведите 'парови', 'тројке' или '4-5 ученика'.
  ...
  - Rotation: Једна реченица која наводи када се улоге ротирају у ОВОМ часу (нпр. „Ротирајте улоге након Фазе А и поново пре галеријске шетње.”).
...
- Укључите временске оријентире, наставников Реците: скрипту, подстицаје за обилазак/праћење рада + очекиване одговоре, и брзу проверу где СВИ ученици одговарају + очекиване одговоре.
