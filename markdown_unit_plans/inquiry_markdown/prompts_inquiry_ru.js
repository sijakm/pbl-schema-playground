          ...
          "properties": {
            ...
            "CreateAnActionPlan": {
              ...
              "properties": {
                "Prompt": {
                  "type": "string",
                  "description": "Создайте сценарий (не включайте префикс «Скажите:») для того, чтобы побудить учащихся определить, что они будут наблюдать, что они будут изменять и что они будут собирать в качестве доказательств."
                },
                "FacilitationMoves": {
                  "type": "array",
      ...
      "properties": {
          ...
          "properties": {
            ...
            "CollaborationExpectations": {
              ...
              "properties": {
                "Prompt": {
                  "type": "string",
                  "description": "Создайте устный сценарий (не включайте префикс «Скажите:»), чтобы представить задание как взаимозависимое и подчеркнуть общую ответственность. Включите инструкции для учащихся использовать начала фраз (например, «Я думаю... потому что...») и структуры участия, такие как жетоны для высказываний."
                },
                "FacilitationMoves": {
                  "type": "array",
                  "description": "Перечислите 3–5 конкретных приёмов или действий учащихся, за которыми следует наблюдать во время групповой работы (например, выявление закономерностей, запись в общих таблицах данных, сравнение интерпретаций). Не добавляйте перед этими действиями префикс «Скажите:». Убедитесь, что они ориентированы на участие всех учащихся в наблюдении и уточнении идей.",
                  "items": {
                    "x-format": "- {value}",
                    "type": "string"
                  }
          ...
          "properties": {
            ...
            "GoDeeper": {
              ...
              "properties": {
                ...
                "AdvancedQuestion": {
                  "type": "string",
                  "description": "Сгенерируйте один сложный вопрос/подсказку (не включайте префикс «Скажите:») для более глубокого концептуального понимания."
                },
                "ExpectedResponses": {
                  "type": "array",
        ...
        "QuickCheck": {
          ...
          "properties": {
            "Question": {
              "type": "string",
              "description": "Сгенерируйте один конкретный вопрос (не включайте префикс «Скажите:») для проверки понимания учащихся во время или в конце исследования."
            },
            "ExpectedResponses": {
              "type": "array",
      ...
      "properties": {
        ...
        "InstructionsForTeachers": {
          ...
          "properties": {
            "OpeningScript": {
              "type": "string",
              "description": "Утверждение (не включайте префикс «Скажите:»), чтобы вернуть учащихся к исследовательскому вопросу и обозначить возникающие идеи о том, как работает конструкция."
            },
            "FacilitationMoves": {
              "type": "array",
            ...
            "WritingPrompt": {
              "type": "string",
              "description": "Утверждение (не включайте префикс «Скажите:»), описывающее, что должно включать их письменное объяснение (содержательные компоненты), и напоминание использовать данные как доказательства."
            },
      ...
      "properties": {
        ...
        "InstructionsForTeachers": {
          ...
          "properties": {
            "OpeningScript": {
              "type": "string",
              "description": "Утверждение (НЕ включайте префикс «Скажите:»), чтобы побудить учащихся подумать о более широких последствиях своих доказательств за пределами класса."
            },
            "FacilitationMoves": {
              "type": "array",
          ...
          "properties": {
            "ActiveRecall": {
              ...
              "properties": {
                "Question": {
                  "type": "string",
                  "description": "Конкретная реплика учителя (НЕ включайте префикс «Скажите:»), которая побуждает учащихся поразмышлять о сегодняшнем исследовании и о том, что оно показало о системе."
                },
                "ExpectedStudentResponses": {
                  "type": "array",
            ...
            "EssentialQuestionConnection": {
              ...
              "properties": {
                "Question": {
                  "type": "string",
                  "description": "Реплика учителя (НЕ включайте префикс «Скажите:»), которая связывает сегодняшние выводы с одним из ключевых вопросов модуля."
                },
                "ExpectedStudentResponses": {
                  "type": "array",
            ...
            "SpacedRetrieval": {
              ...
              "properties": {
                "TeacherSay": {
                  "type": "string",
                  "description": "Реплика учителя (НЕ включайте префикс «Скажите:»), которая явно связывает концепцию из предыдущего урока с сегодняшней работой. В тексте обязательно должна быть метассылка (например, «(Взято из Модуля 1, Урока 2.)»)."
                },
                "ExpectedStudentResponses": {
                  "type": "array",
