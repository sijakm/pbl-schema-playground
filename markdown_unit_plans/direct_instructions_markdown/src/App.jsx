...
export default function App() {
    ...
    try {
      ...
      if (window.utils && window.apiClient && p) {
        ...
        try {
          ...
          const resStep0 = await fetch("http://localhost:5000/api/direct/generate/step0", {
            method: "POST",
        ...
        console.log(`=== .NET API REQUEST: Lessons ===`);
          ...
          const res = await fetch("http://localhost:5000/api/direct/generate/lessons", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
            LessonJsons: lessonJsons.map(obj => JSON.stringify(obj, null, 2)),
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '40px auto', padding: '20px', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ marginBottom: '8px' }}>Direct Instructions Playground</h1>
