...
# Add cyrillic equivalents for grammatical: граммати, грамати
search_pattern = re.compile(r'(^[ \t]*-.*(?:grammati|gramati|gramatikal|граммати|грамати).*)$', re.IGNORECASE | re.MULTILINE)
