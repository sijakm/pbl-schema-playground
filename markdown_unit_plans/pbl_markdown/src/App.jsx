...
export default function App() {
  ...
  const [name, setName] = useState("Engineering and Innovation in Ancient Egypt");
  ...
  const handleRunChain = async () => {
    ...
    log("Starting chain...");
    try {
      if (window.utils && window.apiClient && window.pblPrompts_en) {
        log("Global utils found. Running full chain.");
        const endpoint = DEFAULT_ENDPOINT;
        const p = window.pblPrompts_en;
        const vars = {
          Subject: subject,
          Name: name,
