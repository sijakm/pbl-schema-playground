      ...
      "LessonDescription": {
        ...
        "properties": {
          ...
          "GroupStructureAndRoles": {
            ...
            "properties": {
              "GroupSize": { "type": "string", "description": "e.g. 'pairs', 'triads', or '4-5 students'" },
              "TeacherSay": { "type": "string", "description": "Teacher script explaining roles." },
              "Roles": {
                "type": "object",
                "properties": {
                  "Facilitator": { "type": "string" },
                  "Recorder": { "type": "string" },
                  "MaterialsManager": { "type": "string" },
                  "Timekeeper": { "type": "string" },
                  "Presenter": { "type": "string" }
                },
                "required": ["Facilitator", "Recorder", "MaterialsManager", "Timekeeper", "Presenter"],
                "additionalProperties": false
              },
              "Rotation": { "type": "string", "description": "Sentence specifying when roles rotate." }
            },
            "required": ["GroupSize", "TeacherSay", "Roles", "Rotation"],
            "additionalProperties": false
          },
          ...
          "ReflectionOnGroupDynamics": {
            ...
            "required": ["DebriefPrompt", "TeacherFacilitationOptions", "ClosingPrompt"],
            "additionalProperties": false
          },
          "ReviewAndSpacedRetrieval": {
            "type": "object",
            ...
            "properties": {
              ...
              "ActiveRecall": {
                ...
                "properties": {
                  "Say": { "type": "string", "description": "The teacher prompt." },
                  "ExpectedStudentResponses": { "type": "array", "items": { "type": "string" } },
                  "CorrectCommonMisconceptions": { "type": "array", "items": { "type": "string" }, "description": "1-2 misconceptions and how to correct them." }
                },
                "required": ["Say", "ExpectedStudentResponses", "CorrectCommonMisconceptions"],
                "additionalProperties": false
              },
              ...
              "SpacedRetrieval": {
                ...
                "properties": {
                  "DrawsFrom": { "type": "string", "description": "The prior lesson referenced, e.g. 'Draws from Unit 2, Lesson 3'" },
                  "Say": { "type": "string" },
                  "ExpectedStudentResponses": { "type": "array", "items": { "type": "string" } }
                },
                "required": ["DrawsFrom", "Say", "ExpectedStudentResponses"],
                "additionalProperties": false
              }
            },
            "required": ["Materials", "ActiveRecall", "EssentialQuestionConnection", "TranscendentThinking", "SpacedRetrieval"],
            "additionalProperties": false
          },
          "FormativeAssessment": {
            "type": "array",
            ...
            "items": {
              ...
              "properties": {
                ...
                "Question": { "type": "string", "description": "The exact question text, e.g., 'Why do planets stay in orbit instead of flying off into space?'" },
            ...
            "properties": {
              ...
              "PracticeTasks": {
                ...
                "items": {
                  ...
                  "required": ["TaskDescription", "ExpectedStudentResponses"],
                  "additionalProperties": false
                },
                "minItems": 3,
                "maxItems": 3
