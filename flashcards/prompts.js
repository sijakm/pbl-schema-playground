window.flashcardPrompts = {
    sr: {
        FLASHCARD_PROMPT: `Vaš zadatak je da kreirate kartice za učenje za učenike na osnovu specifičnih lekcija, prateći ova uputstva:
...
Identifikujte odeljke označene kao "core concepts" i "key vocabulary" u sadržaju.
...
Kartice za učenje treba kolektivno da pokriju sve ključne koncepte i rečnik identifikovan u koraku 2, dajući prioritet najvažnijim konceptima ako je broj kartica ograničen.
...
VAŽNO: Nije potrebno dodatno objašnjenje, odgovor treba samo da sadrži generisane kartice za učenje u navedenom JSON formatu. Osigurajte da je JSON čist, dobro struktuiran i da sadrži samo neophodne informacije, bez dodatnog formatiranja poput markdown-a ili navodnika. Izlaz treba da bude jedan JSON objekat sa nizom "flashcards", sa brojem kartica koji odgovara ulaznom parametru. Jezik kartica za učenje treba da bude {{$language}}.`,
    ...
    en: {
        FLASHCARD_PROMPT: `Your task is to create flashcards for students based on specific lessons, following these instructions:
...
Identify the sections labeled "core concepts" and "key vocabulary" for the content
These core concepts and vocabulary should be used to guide the creation of flashcards.
