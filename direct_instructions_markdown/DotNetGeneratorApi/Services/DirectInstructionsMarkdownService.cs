...
public class DirectInstructionsMarkdownService
{
    ...
    public DirectInstructionsMarkdownService()
    {
        string jsPath = Path.Combine(Directory.GetCurrentDirectory(), "..", "prompts.js");
        if (!File.Exists(jsPath))
        {
            jsPath = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "prompts.js");
        }
