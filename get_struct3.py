...
get_keys('direct_instructions_markdown/prompts.js', 'StudentPractice')
get_keys('direct_instructions_markdown/prompts.js', 'ReviewAndSpacedRetrieval')
get_keys('direct_instructions_markdown/prompts.js', 'PracticeTasks')
