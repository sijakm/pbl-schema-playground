...
get_keys('direct_instructions_markdown/prompts.js', 'DirectPresentation')
get_keys('direct_instructions_markdown/prompts.js', 'GuidedPractice')
get_keys('direct_instructions_markdown/prompts.js', 'IndependentPractice')
